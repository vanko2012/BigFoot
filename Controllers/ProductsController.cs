...
namespace big_foot.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(BigfootDbContext context)
        {
            _context = context;
        }
        ...
        {
            var bigfootDbContext = _context.Products.Include(p => p.Categories);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BigfootDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
